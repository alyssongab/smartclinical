...
public class PainelProntuarioController {
    @FXML
    ...
    public void abrirCadastro(){
        try{
            Main m = new Main();
            m.abrirPainel("cadastroProntuario.fxml", "Cadastro de paciente");
        }
        catch (IOException e) {
    ...
    public void consultarProntuario(){
        try{
            Main m = new Main();
            m.abrirPainel("listaProntuario.fxml", "Lista de pacientes");
        }
        catch (IOException e) {
            throw new RuntimeException(e);
        }
