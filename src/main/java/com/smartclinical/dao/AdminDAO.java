...
public class AdminDAO {
    ...
    public void inserirAdmin(Admin admin){
        String inserir = "INSERT INTO admins (nome, telefone,senha, tipoUser) VALUES(?,?,?,?)";
        ...
        try(Connection con = ConexaoBD.getConexao()) {
            ...
            stmt.setString(4, admin.getTipoUsuario().name());

            stmt.executeUpdate();
            System.out.println("SQL: INSERT INTO admins (nome, senha, telefone, tipoUser) VALUES (" + admin.getNome() + ", " + admin.getSenha() + ", " + admin.getTelefone() + ", " + admin.getTipoUsuario().name() + ")");
